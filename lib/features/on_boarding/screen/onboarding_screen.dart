                ...
                children: [
                  ...
                  Padding(
                    padding: EdgeInsets.symmetric(
                        vertical: getHeightSize(context) / 16),
                    child: SmoothPageIndicator(
                      ...
                      effect: WormEffect(
                        ...
                        dotHeight: getHeightSize(context) / 44,
                            ...
                            MaterialButton(
                                ...
                                child: Container(
                                  margin: EdgeInsets.symmetric(
                                      ...
                                      horizontal: getHeightSize(context) / 44),
                                  padding: EdgeInsets.symmetric(
                                      vertical: getWidthSize(context) / 100,
                                      horizontal: getHeightSize(context) / 32),
                                  decoration: BoxDecoration(
                                      // color: AppColors.primary,
                                      borderRadius: BorderRadius.circular(
                                          getHeightSize(context) / 44)),
                                  child: Text(
                                    trans.tr('next'),
                                    style: TextStyle(
                                        fontFamily: 'Tajawal',
